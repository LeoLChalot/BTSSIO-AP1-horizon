...
<section id="CGU">
    ...
    <main>
        ...
        <article id="CGU-divisibilite">
            <h2>Divisibilité</h2>
            <p>Si, à tout moment, rune des dispositions énoncées dans le présent document est jugée incompatible ou invalide en vertu des lois applicables, ces dispositions seront considérées comme nulles et seront retirées du présent document. Toutes les autres dispositions ne seront pas touchées par les lois et le reste du document sera toujours considéré comme valide.</p>
        </article>
        <article id="protection">
            <p>Les informations recueillies proviennent uniquement de la communication volontaire d’une adresse de courrier électronique lors du dépôt d’un message électronique (Formulaire “Contactez-nous” ou commentaire sur un article d’actualité). Votre adresse courriel ne nous servira qu’à vous acheminer la réponse. Elle ne sera en aucun cas transmise ou cédée à un tiers.</p>
        </article>
        <article id="CGU-modifications">
            <h2>Modifications</h2>
            <p>L'éditeur du site se réserve le droit de modifier à tout moment les présentes, notamment en actualisant ce site.</p>
        </article>
